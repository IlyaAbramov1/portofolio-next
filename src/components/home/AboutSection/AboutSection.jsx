...
export default function AboutSection() {
    return (
        <section id="aboutMe" className="innerContainer">
            ...
            <Reveal>
                <p className="text">Сейчас я в креативной студии <a href="https://sirena.sports.ru/" className="link" target="_blank">Сирена↗</a>, делаем проекты для <a href="https://sports.ru/" className="link" target="_blank">Спортс↗</a>. Ранее 3 года в самарской сети <a href="https://dodopizza.ru/samara" className="link" target="_blank">Додо↗</a> и агентстве <a href="http://tomat.team/" className="link" target="_blank">Томат↗</a> занимался дизайном, арт-дирстом и развитием дизайн-команды. Еще я окончил вуз на ракетостроение, постоянно учусь, учу в <a href="https://www.gohelper.io/" className="link" target="_blank">Хелпере↗</a>.</p>
            </Reveal>
            <Reveal>
